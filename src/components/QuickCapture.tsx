...
export default function QuickCapture({ initialText, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed top-[14%] left-1/2 -translate-x-1/2 z-50 w-[560px] bg-[#18181b] border border-white/[0.22] rounded-2xl shadow-2xl overflow-hidden animate-slide-in">
